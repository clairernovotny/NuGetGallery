...
namespace NuGet.Services.Entities
{
    ...
    /// string is used for the <see cref="FederatedCredentialPolicy.Type"/> property.
    /// </summary>
    public static class FederatedCredentialType
    {
        /// <summary>
        ...
        /// </summary>
        public const string EntraIdServicePrincipal = "entra-id.service-principal";
    }
}
