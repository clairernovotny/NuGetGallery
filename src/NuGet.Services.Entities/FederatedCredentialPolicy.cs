...
namespace NuGet.Services.Entities
{
    ...
    public class FederatedCredentialPolicy : IEntity
    {
        ...
        /// <summary>
        /// The key of the user that controls this policy.
        /// </summary>
        ...
        /// <summary>
        /// When this entity was last updated. The timestamp is in UTC.
        /// </summary>
        public DateTime? LastUpdated { get; set; }

        /// <summary>
        /// When this policy was last evaluated against an external credential. The timestamp is in UTC.
        /// </summary>
        public DateTime? LastEvaluated { get; set; }

        /// <summary>
        /// A type string to determine how the <see cref="Criteria"/> field should be interpreted.
        ///
        ...
        /// implied by the <see cref="Type"/> and may not be explicitly states in this field. Only criteria that varies
        ...
        /// <summary>
        /// The navigation property for the controlling user, defined by <see cref="UserKey"/>.
        /// </summary>
